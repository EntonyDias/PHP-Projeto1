...
function listarPeoples()
{
   ...
   foreach ($peoples as $index => $user) {
      echo "<li id='listaAgenda'>" .
         ...
         . "<a href='./agenda.php ? excluirAgenda=" . $index . "'><img src='../Usable/trash_icon.png' alt='Excluir'></a>"
...
{  
   ...
   foreach ($peoples as $index => $user) {
      echo "<li id='listaAcao' class='lista'>"
         . "<a href='./agenda.php ? excluirAgenda=" . $index . "'><img src='../Usable/trash_icon.png' alt='Excluir'></a>"
         . "<a href='./alterarAgenda.php ? editarAgenda=" . $index . "'><img src='../Usable/pencil_icon.png' alt='Alterar'></a>
         </li>";
   } echo "</UL>";
